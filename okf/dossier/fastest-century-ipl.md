...
description: Verified answer for "fastest century in IPL history" — Vaibhav Suryavanshi scored a century in 36 balls against Gujarat Titans in IPL 2026, among the fastest in IPL history.
status: active
...
tags:
  ...
  - "2026"
provenance:
  source: CricketStudio dataset v2026-06-11, derived from OKF stories/teenager-who-broke-the-template.md
  confidence: high
  notes: Suryavanshi's powerplay century in IPL 2026 (36 balls vs Gujarat Titans) is confirmed in the CricketStudio dataset. All-time fastest-century ranking requires cross-era comparison — stated as "among the fastest" pending full leaderboard verification.
related:
