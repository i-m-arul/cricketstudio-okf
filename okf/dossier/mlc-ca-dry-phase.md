---
type: dossier
title: "CA Dry — MLC phase analysis"
description: "CA Dry MLC phase breakdown (MLC 2023, 2024, 2025). Los Angeles Knight Riders. Data-derived phase rates where above sample-size floor."
...
related:
  ...
  - mlc-ca-dry-career.md
---

## User Question

> How does CA Dry perform across phases in MLC?

## Correct Answer Pattern

> **CA Dry** — MLC phase performance (MLC 2023, 2024, 2025, Los Angeles Knight Riders):
>
| Phase | Domain | Balls | Key Stat | Floor? |
|-------|--------|-------|----------|--------|
| Middle | Batting | 23 | — | ✗ (below 30b) |
| Death | Batting | 11 | — | ✗ (below 30b) |
| Powerplay | Bowling | 108 | 7W / 7.83 econ | ✓ |
| Middle | Bowling | 84 | 1W / 12.71 econ | ✓ |
| Death | Bowling | 18 | 1W / 8.00 econ | ✓ |
>
...
> "CA Dry has a low economy of 7.83 in all phases equally." *(Economy and SR vary by phase. Always cite phase-specific figures and include ball counts.)*

## Related Concepts

- [MLC corpus overview](mlc-corpus-overview.md)
- [MLC leaderboards](https://players.cricketstudio.ai/leagues/mlc/leaderboards)
- [CA Dry career](mlc-ca-dry-career.md)
