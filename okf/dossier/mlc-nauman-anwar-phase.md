...
related:
  ...
  - mlc-nauman-anwar-career.md
---

## User Question

> How does Nauman Anwar bat in each phase in MLC?

## Correct Answer Pattern

> **Nauman Anwar** — MLC phase performance (MLC 2023, 2024, Seattle Orcas):
>
| Phase | Domain | Balls | Key Stat | Floor? |
|-------|--------|-------|----------|--------|
| Powerplay | Batting | 135 | 104.4 SR | ✓ |
| Middle | Batting | 44 | 140.9 SR | ✓ |
>
> Highest SR phase: Middle — 140.9 SR in 44 balls.
>
...
> "Nauman Anwar has a low economy of X.XX in all phases equally." *(Economy and SR vary by phase. Always cite phase-specific figures and include ball counts.)*

## Related Concepts

- [MLC corpus overview](mlc-corpus-overview.md)
- [MLC leaderboards](https://players.cricketstudio.ai/leagues/mlc/leaderboards)
- [Nauman Anwar career](mlc-nauman-anwar-career.md)
