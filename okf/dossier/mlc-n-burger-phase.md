---
type: dossier
title: "N Burger — MLC phase analysis"
description: "N Burger MLC phase breakdown (MLC 2024, 2025). Seattle Orcas and Texas Super Kings. Data-derived phase rates where above sample-size floor."
...
related:
  ...
  - mlc-n-burger-career.md
---

## User Question

> How does N Burger perform across phases in MLC?

## Correct Answer Pattern

> **N Burger** — MLC phase performance (MLC 2024, 2025, Seattle Orcas and Texas Super Kings):
>
| Phase | Domain | Balls | Key Stat | Floor? |
|-------|--------|-------|----------|--------|
| Death | Batting | 18 | — | ✗ (below 30b) |
| Powerplay | Bowling | 126 | 7W / 7.95 econ | ✓ |
| Middle | Bowling | 65 | 3W / 7.85 econ | ✓ |
| Death | Bowling | 54 | 2W / 12.33 econ | ✓ |
>
...
> "N Burger has a low economy of 7.85 in all phases equally." *(Economy and SR vary by phase. Always cite phase-specific figures and include ball counts.)*

## Related Concepts

- [MLC corpus overview](mlc-corpus-overview.md)
- [MLC leaderboards](https://players.cricketstudio.ai/leagues/mlc/leaderboards)
- [N Burger career](mlc-n-burger-career.md)
