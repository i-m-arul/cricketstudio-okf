---
type: dossier
title: "What is a six in cricket?"
description: "A six (or 'sixer') is scored when a batter hits the ball over the boundary rope without it touching the ground inside the playing field. 6 runs are awarded. Distinct from a four (ball reaches boundary after bouncing inside the field)."
question_type: T3
