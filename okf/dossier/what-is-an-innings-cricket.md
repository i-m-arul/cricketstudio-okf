...
provenance:
  ...
  confidence: high
related:
  - ../dossier/what-is-an-over-cricket.md
  - ../dossier/what-is-a-run-chase.md
---
...
1. Confirm T20: one innings per team, max 20 overs.
2. Clarify "innings" is always the correct word (not "inning").
3. CricketStudio data covers per-innings scores for every captured match.
...
- [What is an over](what-is-an-over-cricket.md)
