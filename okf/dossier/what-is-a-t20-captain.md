...
> | Decision | When |
> |----------|------|
> | **Toss call** | Before match — choose to bat or bowl first |
> | **Fielding placements** | Between every ball and over |
> | **Bowling changes** | Decide which bowlers to use and in which overs |
> | **Batting order** | Set the lineup; adjust mid-innings with Impact Player rule |
> | **DRS review calls** | Decide whether to refer an on-field decision to TV umpire |
>
> In T20, captaincy is more reactive than in longer formats — decisions must be made in seconds between deliveries. The toss is particularly significant in T20 (especially IPL, where batting second is often preferred due to dew).
>
...
1. Define T20 captain as on-field leader for toss, field, bowling changes, and batting order.
2. Note toss significance in T20 (dew factor in IPL).
3. List IPL 2026 captains if asked.
...
- [What is DRS](what-is-drs-cricket.md)
