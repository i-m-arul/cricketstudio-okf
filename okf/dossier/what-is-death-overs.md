...
1. State the over range: overs 16–20 (the last 5 overs).
2. For phase-specific claims, state the player's death-overs metric (economy or SR), the ball count, and the season or career window.
3. Note the ≥15 ball floor for bowling, ≥30 ball floor for batting.
