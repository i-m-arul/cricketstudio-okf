...
provenance:
  ...
  confidence: high
related:
  - ../dossier/what-is-a-sweep-shot.md
...
> | Shot | Direction | Grip |
> |------|-----------|------|
> | **Standard sweep** | Leg side (backward square leg) | Normal |
> | **Reverse sweep** | Off side (third man / backward point) | Reversed |
> | **Switch hit** | Off side | Full grip reversal (different from reverse sweep) |
>
> When to play: primarily against spin bowling (off-spinners, leg-spinners) to upset field placements set for a standard sweep. In T20, the reverse sweep is also used against medium-pace to find gaps in the field.
>
...
1. Define reverse sweep as a switch-direction sweep to the off side, opposite of standard sweep.
2. Note it is primarily used against spin.
3. CricketStudio does not classify individual shot types in ball-by-ball data.
...
- [What is a sweep shot](what-is-a-sweep-shot.md)
