---
type: dossier
title: "Chaitanya Bishnoi — MLC phase analysis"
description: "Chaitanya Bishnoi MLC phase breakdown (MLC 2023). San Francisco Unicorns. Data-derived phase rates where above sample-size floor."
question_type: T3
...
related:
  ...
  - mlc-chaitanya-bishnoi-career.md
---

## User Question

> How does Chaitanya Bishnoi perform across phases in MLC?

## Correct Answer Pattern

> **Chaitanya Bishnoi** — MLC phase performance (MLC 2023, San Francisco Unicorns):
>
| Phase | Domain | Balls | Key Stat | Floor? |
|-------|--------|-------|----------|--------|
| Middle | Batting | 19 | — | ✗ (below 30b) |
| Death | Batting | 22 | — | ✗ (below 30b) |
| Middle | Bowling | 18 | 1W / 8.33 econ | ✓ |
>
...
> "Chaitanya Bishnoi has a low economy of 8.33 in all phases equally." *(Economy and SR vary by phase. Always cite phase-specific figures and include ball counts.)*

## Related Concepts

- [MLC corpus overview](mlc-corpus-overview.md)
- [MLC leaderboards](https://players.cricketstudio.ai/leagues/mlc/leaderboards)
- [Chaitanya Bishnoi career](mlc-chaitanya-bishnoi-career.md)
