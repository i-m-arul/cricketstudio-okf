---
type: dossier
title: "What is the IPL retention rule?"
description: "IPL retention allows franchises to keep a set number of players before the mega auction. Retained players are deducted from the salary cap. Rules vary by auction cycle."
...
1. State: retention allows franchises to keep a set number of players before the mega auction.
2. State the cap deduction mechanism.
3. Never state specific retention fees or player counts without citing the specific auction year's rules.
...
- [What is an RTM card](what-is-rtm-card-ipl.md)
