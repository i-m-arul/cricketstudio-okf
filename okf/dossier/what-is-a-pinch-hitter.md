...
description: "A pinch hitter in cricket is a lower-order batter promoted up the batting order to attack aggressively at a specific phase — especially the death overs. Distinct from their regular position."
question_type: T3
...
1. Define: a lower-order batter promoted up to attack aggressively at a specific phase.
2. Note the Impact Player connection in IPL 2023+.
3. Do not use "pinch hitter" in formal statistical claims — CricketStudio metrics track batting position, not this label.
