...
1. Define opener as batting positions 1–2 during the Powerplay.
2. For PP SR ranking, cite the ≥30-ball floor and the specific IPL 2026 dataset.
3. CricketStudio phase splits use "Powerplay balls" as the PP batting metric for each player.
