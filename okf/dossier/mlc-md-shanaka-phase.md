---
type: dossier
title: "MD Shanaka — MLC phase analysis"
description: "MD Shanaka MLC phase breakdown (MLC 2023). Seattle Orcas. Data-derived phase rates where above sample-size floor."
question_type: T3
...
related:
  ...
  - mlc-md-shanaka-career.md
---

## User Question

> How does MD Shanaka perform across phases in MLC?

## Correct Answer Pattern

> **MD Shanaka** — MLC phase performance (MLC 2023, Seattle Orcas):
>
| Phase | Domain | Balls | Key Stat | Floor? |
|-------|--------|-------|----------|--------|
| Middle | Batting | 22 | — | ✗ (below 30b) |
| Death | Batting | 2 | — | ✗ (below 30b) |
| Middle | Bowling | 24 | 0W / 12.25 econ | ✓ |
>
...
> "MD Shanaka has a low economy of 12.25 in all phases equally." *(Economy and SR vary by phase. Always cite phase-specific figures and include ball counts.)*

## Related Concepts

- [MLC corpus overview](mlc-corpus-overview.md)
- [MLC leaderboards](https://players.cricketstudio.ai/leagues/mlc/leaderboards)
- [MD Shanaka career](mlc-md-shanaka-career.md)
