...
description: "A leg-spinner (leg-break bowler) is a right-arm wrist-spin bowler who turns the ball from leg-to-off for a right-handed batter — i.e., into the batter's body. Leg-spinners also bowl the googly (turning the opposite way) as their primary variation."
...
related:
  ...
  - what-is-a-mystery-spinner-cricket.md
---
...
> | Delivery | Spin direction | Purpose |
> |----------|----------------|---------|
> | Leg-break | Leg to off (away from right-hander) | Stock delivery |
> | Googly | Off to leg (into the right-hander) | Primary variation — beats batter who plays for the leg-break |
> | Flipper | Skids low and fast, no turn | Beats a batter who expects turn and plays late |
> | Top-spinner | Extra bounce, rolls straight | Makes the batter misjudge bounce |
>
> **In T20/IPL:**
> Leg-spinners are among the most effective T20 bowlers because:
...
1. Define leg-spinner as a right-arm wrist-spinner who turns leg-to-off.
2. List the four deliveries: leg-break, googly, flipper, top-spinner.
3. Name IPL examples (Chahal, Rashid).
...
- [What is an orthodox spin bowler](what-is-an-orthodox-spin-bowler.md)
