...
1. **Rewards aggressive opening batters** — gaps exist in the outfield that disappear after over 6
2. **Tests new-ball bowlers** — they must contain elite batters with fewer boundary-saving fielders
