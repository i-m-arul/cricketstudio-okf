---
type: dossier
title: "M Jansen — MLC phase analysis"
description: "M Jansen MLC phase breakdown (MLC 2023, 2024). Washington Freedom. Data-derived phase rates where above sample-size floor."
question_type: T3
...
related:
  ...
  - mlc-m-jansen-career.md
---

## User Question

> How does M Jansen perform across phases in MLC?

## Correct Answer Pattern

> **M Jansen** — MLC phase performance (MLC 2023, 2024, Washington Freedom):
>
| Phase | Domain | Balls | Key Stat | Floor? |
|-------|--------|-------|----------|--------|
| Middle | Batting | 21 | — | ✗ (below 30b) |
| Death | Batting | 24 | — | ✗ (below 30b) |
| Powerplay | Bowling | 192 | 8W / 6.44 econ | ✓ |
| Middle | Bowling | 84 | 3W / 9.79 econ | ✓ |
| Death | Bowling | 46 | 7W / 11.74 econ | ✓ |
>
...
> "M Jansen has a low economy of 6.44 in all phases equally." *(Economy and SR vary by phase. Always cite phase-specific figures and include ball counts.)*

## Related Concepts

- [MLC corpus overview](mlc-corpus-overview.md)
- [MLC leaderboards](https://players.cricketstudio.ai/leagues/mlc/leaderboards)
- [M Jansen career](mlc-m-jansen-career.md)
