...
related:
  - ../scorebook/mlc/leaderboards/most-innings.md
---

## User Question

> Who has the most innings batted in MLC history?

## Correct Answer Pattern

> **MLC Most innings batted leaderboard** (all-time, MLC seasons 2023, 2024, 2025 (75 matches total)):
>
...
>
> **#1: N Pooran** — 28 (640 balls faced).
>
> Eligibility: Counting stat — all appearances included.
> Source: Cricsheet CC BY 3.0 via CricketStudio, dataset 2026-06-20. Canonical: [https://players.cricketstudio.ai/leagues/mlc/leaderboards/most-innings](https://players.cricketstudio.ai/leagues/mlc/leaderboards/most-innings).
...
- #1: N Pooran — 28 (640 balls faced)
- #2: MD Patel — 26 (523 balls faced)
- #3: Q de Kock — 26 (569 balls faced)
...
> "N Pooran averages 28 per match in MLC." *(The leaderboard shows a career total, not a per-match average. State the metric type — counting total — and the scope — MLC 2023–2025.)*
