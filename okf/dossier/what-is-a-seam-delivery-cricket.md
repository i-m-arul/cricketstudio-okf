---
type: dossier
title: "What is seam bowling (seam delivery) in cricket?"
description: "Seam bowling exploits the raised seam on a cricket ball to generate movement off the pitch. A seam delivery deviates off the seam at the pitch — distinct from swing (which moves through the air) and spin (wrist/finger rotation)."
question_type: T3
...
provenance:
  ...
  confidence: high
related:
  - ../dossier/what-is-pace-bowling-cricket.md
