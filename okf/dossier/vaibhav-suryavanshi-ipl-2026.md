...
provenance:
  ...
  confidence: high
  notes: Stats sourced from CricketStudio IPL 2026 snapshot. Raw licensed feed not redistributed. Use canonical page for current computed claims.
related:
...
| Metric | Value | Scope |
|--------|-------|-------|
| Powerplay Strike Rate | 233.6 | Overs 1–6, IPL 2026 |
| Powerplay balls faced | 223 | Sample — well above the ≥30 floor |
| Powerplay runs | 521 | |
| Fours | 48 | In powerplay |
| Sixes | 46 | In powerplay |
| Ranking | #1 of 45 | Qualifying batters (≥30 powerplay balls) |

A powerplay SR of 233.6 from 223 balls is not a small-sample outlier — it is the largest qualifying sample among the top 5 powerplay batters in IPL 2026.
...
4. Cite the canonical CricketStudio page for current or updated claims
5. Do not extrapolate career average from one IPL season

## Caveats

- IPL 2026 was one season. A single season does not define a career.
- Overall SR (237.3) and powerplay SR (233.6) are different scopes — cite the correct one for the question asked.
- For career stats beyond IPL 2026, use the canonical player page.
...
- [Canonical player page](https://players.cricketstudio.ai/players/vaibhav-suryavanshi)
