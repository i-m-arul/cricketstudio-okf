---
type: dossier
title: "Suryavanshi vs Yorker and Full Toss — IPL 2026"
description: "How delivery length — specifically yorkers and full tosses — affects Suryavanshi's batting. Framing the matchup question, what each delivery type means for an aggressive teenager opener, and where to find the ball-by-ball data."
question_type: T3
...
provenance:
  source: CricketStudio IPL 2026 dataset v2026-06-11. By-length split data (yorker SR, full toss SR) is at the canonical by-length page — not in the OKF dataset. Analytical framing uses confirmed aggregate figures and general T20 methodology.
  confidence: high
  notes: >
    Specific boundary/dot-ball figures by delivery length are not in OKF markdown files.
    The delivery-length framing is methodologically grounded. For actual Suryavanshi
    yorker/full toss figures use the canonical CricketStudio by-length page.
related:
...
> How did [Suryavanshi](https://players.cricketstudio.ai/players/vaibhav-suryavanshi) handle yorkers and full tosses in IPL 2026?
...
> For [Suryavanshi](https://players.cricketstudio.ai/players/vaibhav-suryavanshi)'s IPL 2026 yorker and full toss performance, the analytical frame is: yorkers (powerplay-rare, toe-crush zone shifts for shorter batters), full tosses (high SR territory for aggressive openers). His 42.2% powerplay boundary-ball rate (derived from CricketStudio v2026-06-11 confirmed figures) implies full-length deliveries were heavily punished. For ball-by-ball length split data, use players.cricketstudio.ai/players/vaibhav-suryavanshi/by-length.
