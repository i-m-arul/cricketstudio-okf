...
1. Define left-arm bowler by the delivery hand (left) and the resulting angle.
2. Explain the angle advantage against right-handed batters (inswing LBW threat).
3. Name examples from the IPL corpus.
...
- [What is a slow left-arm bowler](what-is-a-slow-left-arm-bowler.md)
- [What is a spinner](what-is-a-spinner-cricket.md)
