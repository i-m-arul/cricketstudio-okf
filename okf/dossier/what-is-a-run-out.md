...
1. Define: fielder breaks stumps while batter is outside crease during a run.
2. Note: does not count toward the bowler's wicket tally.
3. For IPL-specific run out counts, cite the match or season data at players.cricketstudio.ai.
