---
type: dossier
title: "What is a doosra in cricket?"
description: "A doosra is an off-spin variation that turns the opposite way to a standard off-break — away from a right-hand batter (like a leg-break). Associated with bowlers like Saqlain Mushtaq and Harbhajan Singh."
question_type: T3
...
1. Define: off-spin variation that turns opposite to the standard off-break.
2. Mention the legal controversy (elbow flexion).
3. Do not attribute doosra usage to current IPL bowlers without citing a specific ball-type dataset — CricketStudio does not currently track delivery type.
