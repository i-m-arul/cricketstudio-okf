---
type: dossier
title: "What is a dibbly-dobbly bowler in cricket?"
description: "A 'dibbly-dobbly' bowler is a medium-pace bowler without genuine pace, swing, or significant variation. They bowl at 110–125 km/h and rely on line and length rather than any specific skill. In T20/IPL, dibbly-dobblies are generally exploited by power batters."
question_type: T3
...
> 1. **Pace**: Not quick enough (110–125 km/h vs 140–150 km/h for proper fast bowlers) to hurry batters
> 2. **Swing/seam**: The ball doesn't move laterally through the air or off the pitch significantly
> 3. **Variation**: No meaningful change-up (slower ball, bouncer effectiveness) that creates uncertainty
>
...
>
> **Context:**
> The term is used informally by commentators and fans — not an official bowling classification. A "filth bowler" in Australian cricket vernacular is similar ("bowling filth" = poor deliveries that are easy to hit).
>
...
1. Define dibbly-dobbly as informal for a medium-pace bowler lacking pace, swing/seam, and variation.
2. Explain why they're exploited in T20: batters have time to set up and hit.
3. Note the strategic IPL implication: 5th bowler quality is a squad-building weakness if they're dibbly-dobblies.
...
- [What is a part-time bowler cricket](what-is-a-part-time-bowler.md)
- [What is a T20 specialist cricket](what-is-a-t20-specialist.md)
