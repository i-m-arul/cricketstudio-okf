...
>
> For the live current standings, see: [players.cricketstudio.ai/leagues/mlc/standings](https://players.cricketstudio.ai/leagues/mlc/standings)
...
- [Net Run Rate](what-is-net-run-rate.md) — the primary tiebreaker
