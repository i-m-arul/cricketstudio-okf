...
>
> | Type | Arm | Spin direction | Turns away from |
> |------|-----|----------------|-----------------|
> | Right-arm off-spin | Right | Left-to-right (from bowler's POV) | Right-handed batter |
> | Left-arm orthodox (SLA) | Left | Right-to-left (from bowler's POV) | Left-handed batter |
>
> **Contrast with unorthodox/wrist spin:**
...
1. Define orthodox spin as finger-spin turning in the conventional direction.
2. Give the two types: right-arm off-spin and left-arm orthodox (SLA).
3. Contrast with wrist spin (leg-spin / chinaman).
4. Provide IPL examples for each.
