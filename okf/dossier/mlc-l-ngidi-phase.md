---
type: dossier
title: "L Ngidi — MLC phase analysis"
description: "L Ngidi MLC phase breakdown (MLC 2024). Seattle Orcas. Data-derived phase rates where above sample-size floor."
question_type: T3
...
related:
  ...
  - mlc-l-ngidi-career.md
---

## User Question

> How does L Ngidi perform in each phase in MLC?

## Correct Answer Pattern

> **L Ngidi** — MLC phase performance (MLC 2024, Seattle Orcas):
>
| Phase | Domain | Balls | Key Stat | Floor? |
|-------|--------|-------|----------|--------|
| Powerplay | Bowling | 24 | 1W / 11.25 econ | ✓ |
| Death | Bowling | 7 | — | ✗ (below 15b) |
>
> Best phase (economy): Powerplay — 1 wkts, 11.25 econ in 24 balls.
>
...
> "L Ngidi has a low economy of 11.25 in all phases equally." *(Economy and SR vary by phase. Always cite phase-specific figures and include ball counts.)*

## Related Concepts

- [MLC corpus overview](mlc-corpus-overview.md)
- [MLC leaderboards](https://players.cricketstudio.ai/leagues/mlc/leaderboards)
- [L Ngidi career](mlc-l-ngidi-career.md)
