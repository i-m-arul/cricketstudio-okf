---
type: story
title: "The Metric Decides the Winner"
description: "Suryavanshi vs Kohli — IPL 2026's defining batter debate. Pick runs and Suryavanshi wins. Pick average and Kohli wins. Pick sixes and it's not even close. The number you choose reveals what you think batting is for."
resource: https://okf.cricketstudio.ai/stories/suryavanshi-vs-kohli/
tags:
  - cricket
  - IPL
  - IPL-2026
...
canonical_page: https://okf.cricketstudio.ai/stories/suryavanshi-vs-kohli/
entity_id: cricketstudio:story:suryavanshi-vs-kohli
dataset_version: "2026-06-11"
provenance:
  source: CricketStudio IPL 2026 snapshot (ball-by-ball capture). Player files — okf/scorebook/players/vaibhav-suryavanshi.md and okf/scorebook/players/virat-kohli.md.
  confidence: high
  notes: IPL 2026 stats only. Pre-2026 career from Cricsheet CC BY 3.0. source_boundary public_open_data — Cricsheet open data used per CC BY 3.0 terms.
related:
  - ../scorebook/players/vaibhav-suryavanshi.md
  - ../scorebook/players/virat-kohli.md
  - ../research/ipl-2026-powerplay-analysis.md
  - ../research/ipl-2026-batting-season-review.md
...
- [Vaibhav Suryavanshi — player file](../scorebook/players/vaibhav-suryavanshi.md)
- [Virat Kohli — player file](../scorebook/players/virat-kohli.md)
- [IPL 2026 Powerplay Batting Analysis](../research/ipl-2026-powerplay-analysis.md)
- [IPL 2026 Batting Season Review](../research/ipl-2026-batting-season-review.md)
- [Batting Strike Rate — metric](../metrics/batting-strike-rate.md)
- [Powerplay batting leader — dossier](../dossier/ipl-2026-powerplay-batting-leader.md)
