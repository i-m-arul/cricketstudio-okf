...
canonical_page: https://okf.cricketstudio.ai/stories/rcb-vs-gt-2026/
entity_id: cricketstudio:story:rcb-vs-gt-2026
dataset_version: "2026-06-11"
provenance:
  source: CricketStudio IPL 2026 snapshot (derived claims). Team files — okf/scorebook/teams/royal-challengers-bengaluru.md and okf/scorebook/teams/gujarat-titans.md. Champions file — okf/scorebook/seasons/ipl-2026-champions.md. Player H2H from okf/scorebook/players/virat-kohli.md.
  confidence: high
  notes: All IPL 2026 stats from CricketStudio 2026-06-11 snapshot. source_boundary derived_claims_only. Finals history pre-2026 from Cricsheet CC BY 3.0 via champions hub.
related:
...
Canonical pages:
- [RCB](https://players.cricketstudio.ai/teams/rcb) · [GT](https://players.cricketstudio.ai/teams/gt) · [RCB Champions Hub](https://cricketstudio.ai/season/ipl-2026/champions)

## Related Concepts

- [Royal Challengers Bengaluru — team file](../scorebook/teams/royal-challengers-bengaluru.md)
- [Gujarat Titans — team file](../scorebook/teams/gujarat-titans.md)
- [IPL 2026 Champions — RCB](../scorebook/seasons/ipl-2026-champions.md)
- [Virat Kohli — player file](../scorebook/players/virat-kohli.md)
- [Kagiso Rabada — player file](../scorebook/players/kagiso-rabada.md)
- [State of IPL 2026](../research/state-of-ipl-2026.md)
