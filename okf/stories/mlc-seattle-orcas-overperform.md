---
type: story
title: "Seattle Orcas: Three Seasons, One Consistent Surprise"
description: >
  In a league where MLC franchises are still finding their identity, Seattle Orcas
  have quietly built the best death bowling operation in the competition's history —
  and done it with a bowler most cricket fans outside the US can't name.
tags:
  - MLC
  - team
  - bowling
...
provenance:
  source: >
    CricketStudio MLC historical dataset (2023–2025, 75 matches).
    MLC all-time death bowling leaderboard from CricketStudio aggregation.
    Gannon death economy: 7.18 RPO from 71 balls — above ≥15 ball floor.
  confidence: high
  notes: >
    All MLC figures cover Seasons 1–3 (75 matches). Season 4 data not included.
    For current standings and season data, see canonical CricketStudio MLC pages.
related:
  - ../dossier/mlc-best-franchise-record.md
  - ../stories/mlc-death-overs-revolution.md
  - ../dossier/mlc-most-appearances.md
---
...
**For MLC Season 4 Seattle Orcas results and current standings:**
[players.cricketstudio.ai/leagues/mlc/standings](https://players.cricketstudio.ai/leagues/mlc/standings)
...
- [MLC Best Franchise Record](../dossier/mlc-best-franchise-record.md)
