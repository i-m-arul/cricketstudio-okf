---
type: story
title: "The Franchise That Built Its Powerplay First"
description: >
  Washington Freedom put two of MLC's top three all-time powerplay batters in the same
  lineup. That's not an accident — it's what franchise T20 strategy looks like when it works.
tags:
  - MLC
  - powerplay
  - batting
...
canonical_page: https://okf.cricketstudio.ai/stories/the-washington-freedom-powerplay/
resource: https://okf.cricketstudio.ai/stories/the-washington-freedom-powerplay/
entity_id: cricketstudio:story:the-washington-freedom-powerplay
dataset_version: "2026-06-11"
provenance:
  source: CricketStudio aggregation of Cricsheet CC BY 3.0 (cricsheet.org) — MLC 2023–2025 (75 matches)
  confidence: high
  notes: MLC all-time figures cover 3 seasons (2023–2025). Floor applied — ≥30 powerplay balls faced. 75 total MLC matches in dataset.
related:
  - ../scorebook/mlc/players/mj-owen.md
  - ../scorebook/mlc/players/r-ravindra.md
  - ../scorebook/teams/washington-freedom.md
...
- [MJ Owen player file](../scorebook/mlc/players/mj-owen.md)
- [R Ravindra player file](../scorebook/mlc/players/r-ravindra.md)
