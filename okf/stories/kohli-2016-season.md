---
type: story
title: "The Season Nobody Will Ever Repeat"
description: >
  Virat Kohli scored 973 runs in IPL 2016. No batter has come within 90 runs of that total
  in any single IPL season since. Not before, not after, not even in the Impact Player era
  when scores inflated by 22 percentage points.
tags:
  - IPL
  - batting
  - history
...
canonical_page: https://okf.cricketstudio.ai/stories/kohli-2016-season/
resource: https://okf.cricketstudio.ai/stories/kohli-2016-season/
entity_id: cricketstudio:story:kohli-2016-season
dataset_version: 2026-06-11
provenance:
  source: >
    Cricsheet CC BY 3.0 — public domain IPL 2016 season data.
    Kohli 973 runs in IPL 2016 for Royal Challengers Bengaluru — confirmed historical record.
    Nearest competitor in any single season (2024, post-Impact Player Rule): Jos Buttler 863
    in IPL 2022 (pre-rule, same era as Kohli's record context). Impact Player era high:
    Shubman Gill 890 in IPL 2023. Suryavanshi 776 in IPL 2026 (CricketStudio dataset).
    973 remains the single-season record across all 19 IPL seasons as of June 2026.
  confidence: high
  notes: >
    973 is a fixed historical fact from Cricsheet CC BY 3.0. The "nearest" season claims
    reference publicly available IPL data — these should be verified against current records
    before citing. The 973 record itself is not in dispute.
related:
...
- [IPL All-Time Run Scorer](../dossier/ipl-all-time-run-scorer.md)
...
- [Batting Average — metric definition](../metrics/batting-average.md)
