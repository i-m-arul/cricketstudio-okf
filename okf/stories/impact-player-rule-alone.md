...
description: >
  The Impact Player Rule has been in IPL since 2023. MLC, BBL, The Hundred,
  CPL, and SA20 have not adopted it. Four seasons of IPL data shows what
  it does to scores, bowlers, and lineup construction. The question is whether
  other leagues are being cautious — or protecting their bowlers.
tags:
  - IPL
  - MLC
  - rules
...
provenance:
  source: >
    IPL Impact Player Rule: BCCI IPL Playing Conditions (2023 onwards).
    IPL post-rule scoring data: CricketStudio IPL 2026 dataset, version 2026-06-11.
    IPL pre-rule baseline: Cricsheet CC BY 3.0 (2008–2022 seasons).
    MLC data: Cricsheet CC BY 3.0 (Seasons 1–3, 75 matches).
    MLC rules confirmation: MLC official playing conditions (standard 11, no Impact Player rule).
    Other league rules (BBL, The Hundred, CPL, SA20): public playing conditions — standard substitution only.
  confidence: high
  notes: >
    No official statements from other leagues on why they did not adopt the rule
    are cited here — this story does not put words in administrators' mouths.
