---
type: story
title: "Kohli at 37: The Season His Average Stopped Making Sense"
description: >
  Virat Kohli has played 18 IPL seasons. His average peaked at 81.1 in 2016.
  In IPL 2026, at 37 years old, he posted 56.25. For a career that averaged 39.59
  across 259 pre-2026 matches, that is an unexpected late career arc.
tags:
  - IPL
  - batting
  - player
...
provenance:
  source: >
    Cricsheet CC BY 3.0 for pre-2026 career (259 matches, 8671 runs, 39.59 avg).
    CricketStudio IPL 2026 snapshot (version 2026-06-11) for IPL 2026 figures.
    Season-by-season batting table from Cricsheet CC BY 3.0.
  confidence: high
  notes: >
    All average figures are batting averages (runs per dismissal) — standard IPL metric.
    Career pre-2026 from Cricsheet CC BY 3.0. IPL 2026 from CricketStudio snapshot.
related:
