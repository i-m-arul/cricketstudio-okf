...
description: >
  Three MLC players are posting powerplay strike rates that would rank in IPL 2026's top 10 — above
  Virat Kohli. You almost certainly haven't heard two of their names.
tags:
  - MLC
  - IPL
  - powerplay
...
provenance:
  ...
  confidence: high
  notes: >
    MLC powerplay figures are all-time across 3 seasons. IPL 2026 powerplay figures are for the
    2026 season only. Minimum qualifying threshold: 30 balls faced in the powerplay (overs 1–6).
    All figures from CricketStudio derived-claim layer.
related:
