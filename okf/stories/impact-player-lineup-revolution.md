---
type: story
title: "The Rule That Quietly Rewrote the IPL Lineup"
description: >
  The Impact Player Rule arrived in 2023 as a tactical curiosity. By 2026 it had
  fundamentally changed who gets picked, how teams bat in the middle overs, and
  why 200-plus innings scores tripled in three years.
tags:
  - IPL
  - batting
  - history
...
canonical_page: https://okf.cricketstudio.ai/stories/impact-player-lineup-revolution/
resource: https://okf.cricketstudio.ai/stories/impact-player-lineup-revolution/
entity_id: cricketstudio:story:impact-player-lineup-revolution
dataset_version: 2026-06-11
provenance:
  source: >
    CricketStudio aggregation of Cricsheet CC BY 3.0 historical IPL data (2008–2022)
    for pre-rule baseline. Post-2023 figures from CricketStudio IPL dataset.
    Impact Player Rule implementation: IPL 2023 season (BCCI official).
  confidence: high
  notes: >
    200-plus innings pct computed across all IPL innings from Cricsheet CC BY 3.0
