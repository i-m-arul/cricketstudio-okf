---
type: story
title: "The Franchise That Won and Disappeared: Deccan Chargers"
description: >
  Deccan Chargers won the IPL in 2009. Three years later, BCCI terminated
  their franchise. No other IPL champion has ever been erased from the competition.
  The story of what happened sits at the intersection of cricket, money, and governance.
tags:
  - IPL
  - history
  - team
...
provenance:
  source: >
    Public domain IPL history, corroborated by Cricsheet CC BY 3.0 (match results 2008-2012).
    Franchise termination (2012) from public record — BCCI official announcement.
    Deccan Chargers 2009 title confirmed via Cricsheet CC BY 3.0 match data.
  confidence: high
  notes: >
    Franchise business reasons (non-payment) from public record and widely reported
    in cricket journalism. Do not fabricate specific financial figures.
related:
  - ../dossier/ipl-defunct-franchises.md
  - ../dossier/ipl-champions-history.md
  - ../stories/mi-csk-the-decade.md
---
...
- [IPL Defunct Franchises](../dossier/ipl-defunct-franchises.md)
- [IPL Champions History](../dossier/ipl-champions-history.md)
- [MI vs CSK: The Decade](../stories/mi-csk-the-decade.md)
