---
type: story
title: "Yuzvendra Chahal's 221 Wickets: What the Season-by-Season Journey Shows"
description: >
  Yuzvendra Chahal was the first bowler to take 200 wickets in the IPL.
  He got there in his 153rd IPL match, on 22 April 2024. The season-by-season
  data behind that milestone is not a straight line — it's a curve that tells
  you something about how franchise cricket values leg-spin.
tags:
  - IPL
  - bowling
  - player
...
provenance:
  source: >
    Cricsheet CC BY 3.0 for all pre-2026 career figures (172 matches, 221 wickets).
    CricketStudio IPL 2026 snapshot (version 2026-06-11) for IPL 2026 season (12 matches, 12 wickets).
    200th wicket milestone date (22 April 2024, 153rd IPL match) from Cricsheet CC BY 3.0.
  confidence: high
  notes: >
    Season-by-season table is derived from Cricsheet CC BY 3.0 IPL match data.
    Total of 221 pre-2026 wickets + 12 in IPL 2026 = 233 total IPL wickets at snapshot.
    For current live wicket count, see canonical CricketStudio page.
related:
...
**IPL 2026** (Punjab Kings): 12 matches, 12 wickets, 9.39 economy
*(CricketStudio snapshot, 2026-06-11)*
...
- [Yuzvendra Chahal](../scorebook/players/yuzvendra-chahal.md)
- [IPL All-Time Wicket Taker](../dossier/ipl-all-time-wicket-taker.md)
- [Purple Cap Winners History](../dossier/purple-cap-winners-history.md)
