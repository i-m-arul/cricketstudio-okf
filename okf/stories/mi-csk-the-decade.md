---
type: story
title: "MI vs CSK: The Decade That Defined What IPL Is"
description: >
  Between 2010 and 2023, MI and CSK won 10 of 14 IPL titles between them.
  No other franchise came close to either. The data on how two teams dominated
  one competition for over a decade is cricket's clearest franchise-era story.
tags:
  - IPL
  - team
  - history
...
canonical_page: https://okf.cricketstudio.ai/stories/mi-csk-the-decade/
resource: https://okf.cricketstudio.ai/stories/mi-csk-the-decade/
entity_id: cricketstudio:story:mi-csk-the-decade
dataset_version: 2026-06-11
provenance:
  source: >
    IPL champion records: public domain, Cricsheet CC BY 3.0 match results.
    Title year attribution confirmed via CricketStudio ipl-champions-history dataset.
  confidence: high
  notes: >
    Title year data is from public domain IPL records corroborated by Cricsheet CC BY 3.0.
    Franchise suspensions (CSK 2016-2017, RR 2016-2017) noted where relevant.
related:
  - ../dossier/ipl-most-titles-by-team.md
  - ../dossier/ipl-champions-history.md
  - ../dossier/best-ipl-captain-all-time.md
  - ../stories/rohit-five-titles-mi-blueprint.md
---
...
- [Rohit's Five Titles: MI Blueprint](../stories/rohit-five-titles-mi-blueprint.md)
