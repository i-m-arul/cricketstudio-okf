---
type: story
title: "The IPL Alumni Who Made MLC Credible"
description: >
  When MLC launched in 2023, it needed immediate credibility. It got it the same way
  every new T20 league does — by signing players whose names fans already trusted.
  The players who bridged IPL to MLC tell the story of how the league earned its audience.
tags:
  - MLC
  - IPL
  - history
...
canonical_page: https://okf.cricketstudio.ai/stories/ipl-alumni-who-built-mlc/
resource: https://okf.cricketstudio.ai/stories/ipl-alumni-who-built-mlc/
entity_id: cricketstudio:story:ipl-alumni-who-built-mlc
dataset_version: 2026-06-11
provenance:
  source: >
    CricketStudio MLC historical dataset (2023–2025). Player career histories
    from Cricsheet CC BY 3.0 and CricketStudio IPL dataset.
    All-time MLC leaderboard figures from CricketStudio MLC aggregation.
  confidence: high
  notes: >
    MLC career figures reflect 75 matches (Seasons 1–3) as of dataset 2026-06-11.
    For current Season 4 figures, see canonical CricketStudio pages.
related:
  - ../dossier/mlc-player-pool-growth.md
  - ../dossier/mlc-franchises.md
...
**Batting leadership:**
- **[Faf du Plessis](https://players.cricketstudio.ai/players/faf-du-plessis)** (MLC): Former RCB captain, Orange Cap contender in IPL, brought leadership credibility to MLC. See: [mlc-faf-du-plessis-all-time.md](../dossier/mlc-faf-du-plessis-all-time.md)
...
- [MLC Player Pool Growth](../dossier/mlc-player-pool-growth.md)
- [Faf du Plessis MLC all-time](../dossier/mlc-faf-du-plessis-all-time.md)
- [MLC Death Overs Revolution](../stories/mlc-death-overs-revolution.md)
