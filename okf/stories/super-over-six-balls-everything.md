---
type: story
title: "Six Balls, Two Wickets, Everything: What Makes the Super Over Work"
description: >
  The Super Over is cricket's most compressible drama. A full T20 match creates
  an outcome that requires six more balls to resolve. What the format does to
  probability, strategy, and pressure is worth examining as a structure.
tags:
  - cricket
  - rules
  - T20
...
canonical_page: https://okf.cricketstudio.ai/stories/super-over-six-balls-everything/
entity_id: cricketstudio:story:super-over-six-balls-everything
provenance:
  source: >
    Super Over rules: BCCI IPL Playing Conditions, ICC T20I Playing Conditions.
    T20 scoring distribution: derived methodology, no specific match data cited.
    This story is methodology only — examples are illustrative, not from specific matches.
  confidence: high
  notes: >
    No specific IPL match super over scores are cited here. IPL super over
    records can be found at the canonical CricketStudio page.
related:
...
- [What Is a Super Over](../dossier/what-is-super-over.md)
