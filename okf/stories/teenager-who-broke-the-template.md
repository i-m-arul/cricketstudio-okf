...
description: >
  In 2008, Brendon McCullum scored 158* off 73 balls in the IPL's first-ever match and the cricket
  world had never seen a strike rate like it. In IPL 2026, a 14-year-old casually exceeded that
  rate — just in the powerplay.
tags:
  - IPL
  - batting
  - powerplay
...
provenance:
  source: >
    CricketStudio aggregation of Cricsheet CC BY 3.0 (cricsheet.org) — IPL 2026 season data.
    McCullum's 158* (KKR vs RCB, 2008-04-18) is public domain historical record available in
    Cricsheet CC BY 3.0.
  confidence: high
  notes: >
    Suryavanshi IPL 2026 figures are for the full IPL 2026 season. Powerplay SR computed from
    balls faced in overs 1–6 only (not full innings SR). Minimum qualifying threshold: 30 balls
    for powerplay leaderboard. McCullum SR computed as (158/73)*100 = 216.43 — this is an
    innings-level SR across all overs, not phase-split. The comparison stated in this story is
    deliberately narrow and explicitly scoped.
related:
