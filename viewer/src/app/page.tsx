...
export default async function HomePage() {
  ...
  const jsonLd = {
    ...
    description:
      'A curated, open knowledge catalog for cricket. 3,500+ files covering 922 players, 19 venues, 10 IPL franchises, MLC teams, metric definitions, methodology, and 2,321 verified Q\&A dossier entries. Every claim carries provenance, sample size, source boundary, and canonical CricketStudio links.',
    url: 'https://okf.cricketstudio.ai',
